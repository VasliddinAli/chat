...
<div class="row">
    ...
    <div class="col-sm-4 col-lg-6">
        <div class="card">
            ...
            <div class="card-body p-0" id="chat_area">
...
<script>
            ...
            if (data.data.length > 0) {
                ...
                for (var count = 0; count < data.data.length; count++) {
                    ...
                    if (data.data[count].user_image) {
                        ...
                        user_image = `<img src="https://static.vecteezy.com/system/resources/thumbnails/008/442/086/small_2x/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg" width="40" class="rounded-circle" />`
                    }
            ...
            if (data.data.length > 0) {
				...
				`;
                    ...
                    if (data.data[count].user_image) {
                        ...
                        user_image = `<img src="https://static.vecteezy.com/system/resources/thumbnails/008/442/086/small_2x/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg" width="35" class="rounded-circle" />`;
                    }
	...
	<div class="input-group mb-3">
		<div id="message_area" class="form-control" contenteditable style="min-height:15px; border:1px solid #ccc; border-radius:5px;"></div>
